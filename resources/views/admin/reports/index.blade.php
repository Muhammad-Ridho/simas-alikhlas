    ...
    <div class="card">
        <div class="card-header d-flex flex-column flex-md-row align-items-md-center justify-content-between">
            <div class="text-center my-2 m-2">
                <a href="{{ route('reports.create', []) }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('Tambah Data')</a>
            </div>
            ...
            <table class="table table-striped table-responsive table-hover">
                <thead role="rowgroup">
                    <tr role="row">
                        ...
                        <th role='columnheader'>Tanggal Perolehan</th>
                        <th role='columnheader'>Nilai Perolehan</th>
                        <!-- <th role='columnheader'>Umur Aset</th> -->
                        <th role='columnheader'>Penyusutan Per Bulan</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-label="Tanggal Laporan">{{ $report->asset->tgl_perolehan ? $report->asset->tgl_perolehan->format('d-m-Y') : '' }}</td>
                        ...
                        <td data-label="Penyusutan Per Bulan">Rp. {{ number_format($report->penyusutan_per_bulan, 0, ',', '.') }}</td>
